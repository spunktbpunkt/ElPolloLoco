class MovableObject extends DrawableObject {
    ...
    */
    ...
    isAboveGround() {
        if (isPaused) { return }
        if (this instanceof ThrowableObject || this instanceof EndbossProjectile) {
            return true
        } else {
            return this.y < 130
        }
    ...
    walkingSound() {
        ...
        if (!this.muted) {
            this.walking_sound.volume = soundVolume;
     ...
     * @returns {void}
     */
    playSound(element, volume = soundVolume, intervalId = null) {
        if (isPaused || soundMuted) return;
        if (!this.muted) {
